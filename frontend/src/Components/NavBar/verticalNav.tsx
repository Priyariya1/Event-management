...
export const VerticalNav = () => {
    ...
    return (
        <div className="min-w-[14vw] max-w-[14vw] border-r min-h-full border-slate-200 shadow-md flex bg-blue-100">
            <ul className="flex flex-col min-h-full w-full">
                <li className="pb-6 border-b ">
                    <Link className="btn btn-ghost normal-case text-xl w-full rounded-none text-primary" to="/home">
