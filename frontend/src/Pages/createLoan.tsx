...
export const Loan = () => {
    ...
    const categories = Object.keys(templates?.data ?? {})
        .map((category) => {
            return templates?.data?.[category]?.map((template) => template.name);
        })
        .flat();
    ...
    const interestRate = [
        { interest: 50, duration: 9 },
        { interest: 100, duration: 6 },
        { interest: 200, duration: 8 },
        { interest: 400, duration: 8 },
        { interest:500, duration: 7 },
        { interest: 700, duration: 7 },
        { interest: 1000, duration: 6 },
    ];
    ...
    return (
        <div>
            <h1 className="text-xl px-16 py-4 ">Event Form</h1>
            <form onSubmit={handleSubmit}>
                ...
                <div className="px-16">
                    <div className="py-3 form-control w-full">
                        ...
                        <select name="loan_name" className="select select-primary w-full">
                            {categories.map((key) => (
                                <option>{key}</option>
                            ))}
                        </select>
                    ...
                    <div className="py-3 form-control w-full">
                        <label className="label">
                            <span className="label-text">No of Expected Attendees </span>
                        </label>
                        {/* <input
                            type="number"
                            min={1}
                    ...
                    <div className="py-3 form-control w-full">
                        ...
                        >
                            {interestRate?.map((interestRate) => (
                                <option value={interestRate.duration}>{interestRate.duration} hours</option>
                            ))}
                        </select>
                    </div>
                    ...
                    <div className="py-3 form-control w-full">
                        <label className="label">
                            <span className="label-text">Tell us about your event date and contact details</span>
                        </label>
                        <textarea name="jobDescription" className="textarea textarea-primary"></textarea>
                    </div>
